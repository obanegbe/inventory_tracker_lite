"""
Django settings for inventory_tracker_lite project.
...
SECRET_KEY = 'django-insecure-5y^q7wk(0jprj17%4#l5*44qm6ui3a&59e(t^09mb9spn=@k2t'
...
ROOT_URLCONF = 'inventory_tracker_lite.urls'
